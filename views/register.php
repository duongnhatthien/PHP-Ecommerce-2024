        ...
        <form action="" method="post">
            <div class="space-y-6">
                ...
                <div class="flex items-center">
                    ...
                    <label for="remember-me" class="text-gray-800 ml-3 block text-sm"> I accept the <a
                            href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1">Terms
                            and Conditions</a>
                    </label>
                </div>
            </div>
