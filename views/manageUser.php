    ...
    <div class="w-full max-w-full">
        <div class="flex flex-col w-full max-w-full">
            <div class="overflow-x-auto pb-4">
                <div class="max-w-full w-full inline-block align-middle">
                    <div class="border rounded-lg border-gray-300">
                        <table class="table-auto w-full max-w-full rounded-xl">
                            <thead>
                                <tr class="bg-gray-600">
                                    <th class="">
                                        <div class="flex items-center py-5 px-5 ">
                                            <input type="checkbox" value=""
                                                class="bg-white w-5 h-5 appearance-none border border-gray-300  rounded-md mr-2 hover:border-indigo-500 hover:bg-indigo-300 checked:bg-no-repeat checked:bg-center checked:border-indigo-500 checked:bg-indigo-300">
                                        </div>
                                    </th>
                                    <th scope="col"
                                        class="p-5 text-white text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">
                                        Company </th>
                                    <th scope="col"
                                        class="p-5 text-white  text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">
                                        User ID </th>
                                    <th scope="col"
                                        class="p-5 text-white  text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]">
                                        Full Name &amp; Email </th>
                                    <th scope="col"
                                        class="p-5 text-white  text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">
                                        Type </th>
                                    ...
                                    <th scope="col"
                                        class="text-white p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">
                                        Country </th>
                                    <th scope="col"
                                        class="text-white p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize">
                                        Status </th>
                            ...
                            <tbody class="divide-y divide-gray-300 ">
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    <td class="">
                                        <div class="flex items-center py-5 px-5 ">
                                            <input type="checkbox" value=""
                                                class="w-5 h-5 appearance-none border border-gray-300  rounded-md mr-2 hover:border-indigo-500 hover:bg-indigo-300 checked:bg-no-repeat checked:bg-center checked:border-indigo-500 checked:bg-indigo-300">
                                        </div>
                                    </td>
                                    ...
                                    <td class=" px-5 py-3">
                                        <div class="w-48 flex items-center gap-3">
                                            <img src="https://pagedone.io/asset/uploads/1697536419.png"
                                                alt="Floyd image">
                                            <div class="data">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        Accessories</td>
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Jun.
                                        24,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $18,500
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        Electronics </td>
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Feb.
                                        23,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $50,00
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="w-48 px-5 py-3 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <img src="https://pagedone.io/asset/uploads/1697536451.png"
                                                alt="Cameron image">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Oct.
                                        23,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $108,500
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="w-48 px-5 py-3">
                                        <div class="flex items-center gap-3">
                                            <img src="https://pagedone.io/asset/uploads/1697536466.png"
                                                alt="Darrell image">
                                            <div class="data">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Jul.
                                        12,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $8,500
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="w-48 px-5 py-3">
                                        <div class="flex items-center gap-3">
                                            <img src="https://pagedone.io/asset/uploads/1697536479.png"
                                                alt="Laura image">
                                            <div class="data">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Sep.
                                        29,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $1,500
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="w-48 px-5 py-3">
                                        <div class="flex items-center gap-3">
                                            <img src="https://pagedone.io/asset/uploads/1697536494.png"
                                                alt="Alfred image">
                                            <div class="data">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        Entertainment</td>
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Dec.
                                        02,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $18,500
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> IBM
                                    </td>
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        20010516
                                    </td>
                                    <td class="w-48 px-5 py-3 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <img src="https://pagedone.io/asset/uploads/1697536512.png"
                                                alt="Claire image">
                                            <div class="data min-w-[150px]">
                                                <p class="font-normal text-sm text-gray-900 whitespace-nowrap">Claire
                                                    Tran
                                                </p>
                                                <p
                                                    class="font-normal text-xs leading-5 text-gray-400 whitespace-nowrap">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        Electronics</td>
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Jan.
                                        09,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $50,00
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> LG
                                    </td>
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        20010517
                                    </td>
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Mar.
                                        15,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $55,000
                                ...
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="w-48 px-5 py-3 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <img src="https://pagedone.io/asset/uploads/1697536552.png"
                                                alt="Richard image">
                                            <div class="data min-w-[150px]">
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        Manufacturing</td>
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Apr.
                                        02,
                                        2023 </td>
                                    <!-- <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        $99,999
